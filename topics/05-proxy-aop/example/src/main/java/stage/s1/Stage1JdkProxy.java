...
/**
 * STAGE 1-1 — JDK Dynamic Proxy 손 작성.
 *
 * <h3>관찰 포인트</h3>
 * <ul>
 *   <li>proxy.getClass() = $Proxy0 / $Proxy1 ... (GreeterImpl 아님)</li>
 *   <li>인터페이스 (Greeter) 의 모든 메서드를 InvocationHandler 가 처리</li>
 *   <li>인터페이스 없는 클래스에는 적용 불가</li>
 * </ul>
 */
