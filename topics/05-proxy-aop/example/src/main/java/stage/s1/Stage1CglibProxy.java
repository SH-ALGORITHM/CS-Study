...
// Spring 내장 CGLIB — net.sf.cglib 직접 추가하면 충돌
import org.springframework.cglib.proxy.Enhancer;
import org.springframework.cglib.proxy.MethodInterceptor;

/**
 * STAGE 1-2 — CGLIB Proxy 손 작성 (인터페이스 없는 클래스).
 *
 * <h3>관찰 포인트</h3>
 * <ul>
 *   <li>proxy.getClass() = Counter$$EnhancerByCGLIB$$... (Counter 의 자식)</li>
 *   <li>proxy instanceof Counter = true (상속이므로)</li>
 *   <li>final 클래스로 바꾸면 IllegalArgumentException</li>
 * </ul>
 */
