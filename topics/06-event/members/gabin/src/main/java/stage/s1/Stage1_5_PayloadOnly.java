...
public class Stage1_5_PayloadOnly {
    ...
    public static class Publisher {
        ...
        public void publishAll() {
            ...
            publisher.publishEvent(new OrderCompletedEvent(1L, "ORD-2026-0001"));
    ...
    public static class RecordListener {
        ...
        public void on(OrderCompletedEvent e) {
            System.out.println("  [record] orderId=" + e.orderId()
    ...
    public static void main(String[] args) {
        ...
        MeasurementLog.record(
            "s1-5",
            "ApplicationEvent 상속 없이 record와 String payload 이벤트 수신"
        );
        ctx.close();
    }
}
