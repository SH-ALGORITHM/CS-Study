...
| 이름 | 폴더 | 1주차 도메인 | 2주차 도메인 | 3주차 도메인 |
|---|---|---|---|---|
| 오찬혁 | `chanhyeok` | 선착순 쿠폰 | 호텔 객실 예약 | (미정) |
| 김가빈 | `gabin` | 이중 환불 | 장바구니 결제 | (미정) |
| 김민서 | `minseo` | 출퇴근 기록 | 회의실 / 스터디룸 예약 | (미정) |
| 강희민 | `huimin` | 재고 관리 | 재고 입출고 | (미정) |
| 한재훈 | `jaehoon` | 조회수 / 좋아요 | 환전 / 통화 거래 | (미정) |
| 이가은 | `gaeun` | 콘서트 좌석 | 계좌 이체 | (미정) |
| 박수진 | `sujin` | volatile 집중 | 콘서트 좌석 예약 | (미정) |
